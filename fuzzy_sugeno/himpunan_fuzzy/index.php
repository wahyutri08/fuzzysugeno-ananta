...
$query = query("SELECT fs.*, v.nama_variabel 
                FROM fuzzy_set fs
                JOIN variabel v ON fs.id_variabel = v.id_variabel
                ORDER BY v.id_variabel ASC");
                        ...
                        <div class="col">
                            <div class="card card-outline card-warning">
                                <div class="card-header text-left">
                                    <a href="<?= base_url('fuzzy_sugeno/himpunan_fuzzy/tambah') ?>" class="btn btn-sm bg-gradient-warning mr-2">
                                                    ...
                                                    <td class="text-center" style="width: 8px;">
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input custom-control-input-danger checkbox-item"
                                                                type="checkbox"
                                                                id="check<?= htmlspecialchars($row['id_set']); ?>"
                                                                value="<?= htmlspecialchars($row['id_set']); ?>">
                                                            <label for="check<?= htmlspecialchars($row['id_set']); ?>" class="custom-control-label"></label>
                                                        </div>
                                                    </td>
                                                    <td class="text-center"><?= $i + 1; ?></td>
                                                    <td class="text-center"><?= htmlspecialchars($row['nama_variabel']); ?></td>
                                                    <td class="text-center"><?= htmlspecialchars($row['nama_set']); ?></td>
                                                    <td class="text-center"><?= htmlspecialchars($row['a']); ?></td>
                                                    <td class="text-center"><?= htmlspecialchars($row['b']); ?></td>
                                                    <td class="text-center"><?= htmlspecialchars($row['c']); ?></td>
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                <li><a class="dropdown-item" href="<?= base_url('fuzzy_sugeno/himpunan_fuzzy/edit/' . $row['id_set']) ?>"><i class="fas fa-edit"></i> Edit</a></li>
                                                                <li><a href="#"
