                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><?= htmlspecialchars($users["name"]); ?></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <span class="nav-icon fas fa-user"></span> &nbsp;<?= htmlspecialchars($users["name"]); ?>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name" placeholder="name" value="<?= htmlspecialchars($users["name"]); ?>">
                                                </div>
                                                <div class="form-group">
